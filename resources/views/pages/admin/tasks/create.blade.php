...
<div class="container-fluid">
    <div class="col-lg-12 mb-lg-0 pb-4">
        <h6 class="font-weight-bolder mb-0 main-topic-area">Add Task</h6>
    </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="row mt-3">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="task_title" id="task_title" value="{{ old('task_title') }}"/>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control" name="task_deadline" id="task_deadline" value="{{ old('task_deadline') }}"/>
